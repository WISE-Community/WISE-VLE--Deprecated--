 ...
 * 
 * Edited for WISE4 by Jonathan Breitbart
 * 
 */
			...
			*/
			...
			var clickLine = function() {
				if (toolButtonClick('#tool_line')) {
					...
					workarea.css('cursor','crosshair'); // update cursor (wise4)
				}
			};
			...
			var clickText = function(){
				...
				workarea.css('cursor','text'); // update cursor (wise4)
			};
...
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/draw/svg-edit/svg-editor.js');
};