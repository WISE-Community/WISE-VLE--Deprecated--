 ...
 */
SurgeState.prototype.parseDataJSONObj = function(stateJSONObj) {
 ...
 */
SurgeState.prototype.getStudentWork = function() {
...
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/node/surge/surgeState.js');
}