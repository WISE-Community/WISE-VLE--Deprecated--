...
public final class SecurityUtils {
	...
	private final static List<String> ALLOWED_REFERRERS;
	   static{
	...
	private static boolean portalMode = false;
	...
	public static boolean isPortalMode(HttpServletRequest request){
		if(retrievedPortalMode){
			...
			try{
				String response = Connector.request(urlBase + MODEMASTER_URL, "portalMode");
				retrievedPortalMode = true;
