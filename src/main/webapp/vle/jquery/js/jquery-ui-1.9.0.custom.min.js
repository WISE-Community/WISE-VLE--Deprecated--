 ...
 *	jquery.ui.menu.js
 */
(function(e,t){e.widget("ui.selectmenu",{version:"@VERSION",defaultElement:"<select>",options:{dropdown:!0,appendTo:"body",position:{my:"left top",at:"left bottom",collision:"none"},open:null,focus:null,select:null,close:null,change:null},_create:function(){var t=this.element.uniqueId().attr("id");this.ids={id:t,button:t+"-button",menu:t+"-menu"},this._on({click:function(e){this.button.focus(),e.preventDefault()}}),this._drawButton(),this._on(this.button,this._buttonEvents),this._hoverable(this.button),this._focusable(this.button),this._drawMenu(),this._on(document,{click:function(t){this.isOpen&&!e(t.target).closest("li.ui-state-disabled, li.ui-selectmenu-optgroup, #"+this.ids.button).length&&this.close(t)}}),this.options.disabled&&this.disable()},_drawButton:function(){var t=this.element.attr("tabindex");this.labelElement=e("label[for='"+this.element.attr("id")+"']").uniqueId(),this.element.hide(),this.button=e("<a />",{"class":"ui-button ui-widget ui-state-default ui-corner-all",href:"#"+this.ids.id,tabindex:t?t:this.options.disabled?-1:0,id:this.ids.button,width:this.element.outerWidth(),role:"combobox","aria-labelledby":this.labelElement.attr("id"),"aria-expanded":!1,"aria-autocomplete":"list","aria-owns":this.ids.menu,"aria-haspopup":!0}),this.button.prepend(e('<span class="ui-icon '+(this.options.dropdown?"ui-icon-triangle-1-s":"ui-icon-triangle-2-n-s")+'"/>')),this.buttonText=e("<span />",{"class":"ui-selectmenu-text",html:this.element.find("option:selected").text()||"&nbsp;"}).appendTo(this.button),this.buttonWrap=e("<span />",{"class":"ui-selectmenu-button"}).append(this.button).insertAfter(this.element)},_drawMenu:function(){var n,r=this;this.menu=e("<ul />",{"aria-hidden":!0,"aria-labelledby":this.ids.button,id:this.ids.menu}),this.menuWrap=e("<div />",{"class":"ui-selectmenu-menu",width:this.options.dropdown?this.button.outerWidth():this.buttonText.width()+parseFloat(this.buttonText.css("padding-left"))||0+parseFloat(this.buttonText.css("margin-left"))||0}).append(this.menu).appendTo(this.options.appendTo),n=this.menu.menu({select:function(e,t){var n=t.item.data("item.selectmenu");r._select(n,e),r.isOpen&&(e.preventDefault(),r.close(e))},focus:function(e,n){var i=n.item.data("item.selectmenu");r.focus!==t&&i.index!==r.focus&&(r._trigger("focus",e,{item:i}),r.isOpen||r._select(i,e)),r.focus=i.index,r.button.attr("aria-activedescendant",i.element.attr("id"))},role:"listbox"}).data("ui-menu"),this.options.dropdown&&this.menu.addClass("ui-corner-bottom").removeClass("ui-corner-all"),n._off(this.menu,"mouseleave")},refresh:function(){this.menu.empty();var e,t=this.element.find("option");t.length&&(this._readOptions(t),this._renderMenu(this.menu,this.items),this.menu.menu("refresh"),this.menuItems=this.menu.find("li").not(".ui-selectmenu-optgroup"),e=this._getSelectedItem(),this.menu.menu("focus",null,e),this._setSelected(e.data("item.selectmenu")),this._setOption("disabled",this._getCreateOptions().disabled))},open:function(n){if(!this.options.disabled){this.isOpen===t&&this.button.trigger("focus"),this.isOpen=!0,this._toggleAttr();if(this.items&&!this.options.dropdown){var r=this._getSelectedItem();this.menu.outerHeight()<this.menu.prop("scrollHeight")&&(this.menuWrap.css("left",-1e4),this.menu.scrollTop(this.menu.scrollTop()+r.position().top-this.menu.outerHeight()/2+r.outerHeight()/2),this.menuWrap.css("left","auto")),e.extend(this.options.position,{my:"left top",at:"left top",offset:"0 "+(this.menu.offset().top-r.offset().top+(this.button.outerHeight()-r.outerHeight())/2)})}this.options.position.of=this.button,this.menuWrap.zIndex(this.element.zIndex()+1).position(this.options.position),this._trigger("open",n)}},close:function(e){this.isOpen&&(this.isOpen=!1,this._toggleAttr(),this._trigger("close",e))},widget:function(){return this.button},menuWidget:function(){return this.menu},_renderMenu:function(t,n){var r=this,i="";e.each(n,function(n,s){s.optgroup!==i&&(e("<li />",{"class":"ui-selectmenu-optgroup"+(s.element.parent("optgroup").attr("disabled")?" ui-state-disabled":""),html:s.optgroup}).appendTo(t),i=s.optgroup),r._renderItem(t,s)})},_renderItem:function(t,n){var r=e("<li />").data("item.selectmenu",n);return n.disabled&&r.addClass("ui-state-disabled"),r.append(e("<a />",{html:n.label,href:"#"})),r.appendTo(t)},_move:function(e,t){e==="first"||e==="last"?this.menu.menu("focus",t,this.menuItems[e]()):this.menu.menu(e,t)},_getSelectedItem:function(){return this.menuItems.eq(this.element[0].selectedIndex)},_toggle:function(e){this.isOpen?this.close(e):this.open(e)},_buttonEvents:{focus:function(e){this.refresh(),this._off(this.button,"focus")},click:function(e){this._toggle(e),e.preventDefault()},keydown:function(t){var n=!0;switch(t.keyCode){case e.ui.keyCode.TAB:case e.ui.keyCode.ESCAPE:this.isOpen&&this.close(t),n=!1;break;case e.ui.keyCode.ENTER:this.isOpen&&this.menu.menu("select",t);break;case e.ui.keyCode.UP:t.altKey?this._toggle(t):this._move("previous",t);break;case e.ui.keyCode.DOWN:t.altKey?this._toggle(t):this._move("next",t);break;case e.ui.keyCode.SPACE:this._toggle(t);break;case e.ui.keyCode.LEFT:this._move("previous",t);break;case e.ui.keyCode.RIGHT:this._move("next",t);break;case e.ui.keyCode.HOME:case e.ui.keyCode.PAGE_UP:this._move("first",t);break;case e.ui.keyCode.END:case e.ui.keyCode.PAGE_DOWN:this._move("last",t);break;default:this.menu.trigger(t),n=!1}n&&t.preventDefault()}},_select:function(e,t){var n=this.element[0].selectedIndex;this.element[0].selectedIndex=e.index,this._setSelected(e),this._trigger("select",t,{item:e}),e.index!==n&&this._trigger("change",t,{item:e})},_setSelected:function(e){this.buttonText.html(e.label),this.menuItems.find("a").attr("aria-selected",!1),this._getSelectedItem().find("a").attr("aria-selected",!0),this.button.attr("aria-activedescendant",e.element.attr("id"))},_setOption:function(t,n){this._super(t,n),t==="appendTo"&&this.menuWrap.appendTo(e(n||"body",this.element[0].ownerDocument)[0]),t==="disabled"&&(this.menu.menu("option","disabled",n),n?(this.element.attr("disabled","disabled"),this.button.attr("tabindex",-1),this.close()):(this.element.removeAttr("disabled"),this.button.attr("tabindex",0)))},_toggleAttr:function(){this.options.dropdown&&this.button.toggleClass("ui-corner-top",this.isOpen).toggleClass("ui-corner-all",!this.isOpen),this.menuWrap.toggleClass("ui-selectmenu-open",this.isOpen),this.menu.attr("aria-hidden",!this.isOpen),this.button.attr("aria-expanded",this.isOpen)},_getCreateOptions:function(){return{disabled:!!this.element.attr("disabled")}},_readOptions:function(t){var n=[];e.each(t,function(t,r){var i=e(r),s=i.parent("optgroup");n.push({element:i,index:t,value:i.attr("value"),label:i.text()||"&nbsp;",optgroup:s.attr("label")||"",disabled:s.attr("disabled")||i.attr("disabled")})}),this.items=n},_destroy:function(){this.menuWrap.remove(),this.buttonWrap.remove(),this.element.show(),this.labelElement.removeUniqueId()}})})(jQuery);

//used to notify scriptloader that this script has finished loading
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/jquery/js/jquery-ui-1.9.0.custom.min.js');
}