 ...
 *	jquery.ui.menu.js
 */
(function(e,t){e.widget("ui.selectmenu",{version:"@VERSION",defaultElement:"<select>",options:{appendTo:null,icons:{button:"ui-icon-triangle-1-s"},position:{my:"left top",at:"left bottom",collision:"none"},change:null,close:null,focus:null,open:null,select:null},_create:function(){var e=this.element.uniqueId().attr("id");this.ids={element:e,button:e+"-button",menu:e+"-menu"};this._drawButton();this._drawMenu();if(this.options.disabled){this.disable()}},_drawButton:function(){var t=this.element.attr("tabindex");this.label=e("label[for='"+this.ids.element+"']").attr("for",this.ids.button);this._on(this.label,{click:function(e){this.button.focus();e.preventDefault()}});this.element.hide();this.button=e("<span>",{"class":"ui-selectmenu-button ui-widget ui-state-default ui-corner-all",tabindex:t||this.options.disabled?-1:0,id:this.ids.button,width:this.element.outerWidth(),role:"combobox","aria-expanded":"false","aria-autocomplete":"list","aria-owns":this.ids.menu,"aria-haspopup":"true"}).insertAfter(this.element);e("<span>",{"class":"ui-icon "+this.options.icons.button}).prependTo(this.button);this.buttonText=e("<span>",{"class":"ui-selectmenu-text"}).appendTo(this.button);this._setText(this.buttonText,this.element.find("option:selected").text());this._on(this.button,this._buttonEvents);this._hoverable(this.button);this._focusable(this.button)},_drawMenu:function(){var t=this;this.menu=e("<ul>",{"aria-hidden":"true","aria-labelledby":this.ids.button,id:this.ids.menu});this.menuWrap=e("<div>",{"class":"ui-selectmenu-menu ui-front",outerWidth:this.button.outerWidth()}).append(this.menu).appendTo(this._appendTo());this.menuInstance=this.menu.menu({select:function(e,n){var r=n.item.data("ui-selectmenu-item");t._select(r,e);if(t.isOpen){e.preventDefault();t.close(e)}},focus:function(e,n){var r=n.item.data("ui-selectmenu-item");if(t.focusIndex!=null&&r.index!==t.focusIndex){t._trigger("focus",e,{item:r});if(!t.isOpen){t._select(r,e)}}t.focusIndex=r.index;t.button.attr("aria-activedescendant",t.menuItems.eq(r.index).attr("id"))},role:"listbox"}).menu("instance");this.menu.addClass("ui-corner-bottom").removeClass("ui-corner-all");this.menuInstance._off(this.menu,"mouseleave");this.menuInstance._closeOnDocumentClick=function(){return false}},refresh:function(){this.menu.empty();var e,t=this.element.find("option");if(!t.length){return}this._readOptions(t);this._renderMenu(this.menu,this.items);this.menu.menu("refresh");this.menuItems=this.menu.find("li").not(".ui-selectmenu-optgroup").find("a");e=this._getSelectedItem();this.menu.menu("focus",null,e);this._setAria(e.data("ui-selectmenu-item"));this._setText(this.buttonText,e.text());this._setOption("disabled",!!this.element.prop("disabled"))},open:function(e){if(this.options.disabled){return}if(!this.menuItems){this.refresh()}else{this.menu.find(".ui-state-focus").removeClass("ui-state-focus");this.menu.menu("focus",null,this._getSelectedItem())}this.isOpen=true;this._toggleAttr();this._position();this._on(this.document,this._documentClick);this._trigger("open",e)},_position:function(){this.menuWrap.position(e.extend({of:this.button},this.options.position))},close:function(e){if(!this.isOpen){return}this.isOpen=false;this._toggleAttr();if(this.menuItems){this.menuInstance.active=this._getSelectedItem()}this._off(this.document);this._trigger("close",e)},widget:function(){return this.button},menuWidget:function(){return this.menu},_renderMenu:function(t,n){var r=this,i="";e.each(n,function(n,s){if(s.optgroup!==i){e("<li>",{"class":"ui-selectmenu-optgroup"+(s.element.parent("optgroup").attr("disabled")?" ui-state-disabled":""),text:s.optgroup}).appendTo(t);i=s.optgroup}r._renderItemData(t,s)})},_renderItemData:function(e,t){return this._renderItem(e,t).data("ui-selectmenu-item",t)},_renderItem:function(t,n){var r=e("<li>"),i=e("<a>",{href:"#"});if(n.disabled){r.addClass("ui-state-disabled")}this._setText(i,n.label);return r.append(i).appendTo(t)},_setText:function(e,t){if(t){e.text(t)}else{e.html("&#160;")}},_move:function(e,t){if(e==="first"||e==="last"){this.menu.menu("focus",t,this.menuItems[e]())}else{if(e==="previous"&&this.menu.menu("isFirstItem")||e==="next"&&this.menu.menu("isLastItem")){return}this.menu.menu(e,t)}},_getSelectedItem:function(){return this.menuItems.eq(this.element[0].selectedIndex).parent("li")},_toggle:function(e){if(this.isOpen){this.close(e)}else{this.open(e)}},_documentClick:{click:function(t){if(this.isOpen&&!e(t.target).closest("li.ui-state-disabled, li.ui-selectmenu-optgroup, #"+this.ids.button).length){this.close(t)}}},_buttonEvents:{focus:function(){this.refresh();this.button.addClass("ui-state-focus");this._off(this.button,"focus")},click:function(e){this._toggle(e);e.preventDefault()},keydown:function(t){var n=true;switch(t.keyCode){case e.ui.keyCode.TAB:case e.ui.keyCode.ESCAPE:if(this.isOpen){this.close(t)}n=false;break;case e.ui.keyCode.ENTER:if(this.isOpen){this.menu.menu("select",t)}break;case e.ui.keyCode.UP:if(t.altKey){this._toggle(t)}else{this._move("previous",t)}break;case e.ui.keyCode.DOWN:if(t.altKey){this._toggle(t)}else{this._move("next",t)}break;case e.ui.keyCode.SPACE:if(this.isOpen){this.menu.menu("select",t)}else{this._toggle(t)}break;case e.ui.keyCode.LEFT:this._move("previous",t);break;case e.ui.keyCode.RIGHT:this._move("next",t);break;case e.ui.keyCode.HOME:case e.ui.keyCode.PAGE_UP:this._move("first",t);break;case e.ui.keyCode.END:case e.ui.keyCode.PAGE_DOWN:this._move("last",t);break;default:this.menu.trigger(t);n=false}if(n){t.preventDefault()}}},_select:function(e,t){var n=this.element[0].selectedIndex;this.element[0].selectedIndex=e.index;this._setText(this.buttonText,e.label);this._setAria(e);this._trigger("select",t,{item:e});if(e.index!==n){this._trigger("change",t,{item:e})}},_setAria:function(e){var t=this.menuItems.eq(e.index),n=t.attr("id");this.button.attr({"aria-labelledby":n,"aria-activedescendant":n});this.menu.attr("aria-activedescendant",n)},_setOption:function(e,t){if(e==="icons"){this.button.find("span.ui-icon").removeClass(this.options.icons.button).addClass(t.button)}this._super(e,t);if(e==="appendTo"){this.menuWrap.appendTo(this._appendTo())}if(e==="disabled"){this.menu.menu("option","disabled",t);this.button.toggleClass("ui-state-disabled",!!t).attr("aria-disabled",t);if(t){this.element.attr("disabled","disabled");this.button.attr("tabindex",-1);this.close()}else{this.element.removeAttr("disabled");this.button.attr("tabindex",0)}}},_appendTo:function(){var t=this.options.appendTo;if(t){t=t.jquery||t.nodeType?e(t):this.document.find(t).eq(0)}if(!t){t=this.element.closest(".ui-front")}if(!t.length){t=this.document[0].body}return t},_toggleAttr:function(){this.button.toggleClass("ui-corner-top",this.isOpen).toggleClass("ui-corner-all",!this.isOpen);this.menuWrap.toggleClass("ui-selectmenu-open",this.isOpen);this.menu.attr("aria-hidden",!this.isOpen);this.button.attr("aria-expanded",this.isOpen)},_getCreateOptions:function(){return{disabled:!!this.element.prop("disabled")}},_readOptions:function(t){var n=[];t.each(function(t,r){var i=e(r),s=i.parent("optgroup");n.push({element:i,index:t,value:i.attr("value"),label:i.text(),optgroup:s.attr("label")||"",disabled:s.attr("disabled")||i.attr("disabled")})});this.items=n},_destroy:function(){this.menuWrap.remove();this.button.remove();this.element.show();this.element.removeUniqueId();this.label.attr("for",this.ids.element)}})})(jQuery);

//used to notify scriptloader that this script has finished loading
if(typeof eventManager != 'undefined'){
	eventManager.fire('scriptLoaded', 'vle/jquery/js/jquery-ui-1.10.3.custom.min.js');
}