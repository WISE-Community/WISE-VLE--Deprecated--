...
NavigationPanel.prototype.menuCreated = function() {
	// move sidebar to right of the page
	$('#vleSidebar').removeClass('sidebarLeft').addClass('sidebarRight');
	$('#stepContent').removeClass('contentRight').addClass('contentLeft');
...
if(typeof eventManager != 'undefined'){
	 ...
	 */
	eventManager.fire('scriptLoaded', 'vle/themes/wise_alternate/navigation/classic_right/nav.js');
};