 ...
 */
IdeaBasketState.prototype.parseDataJSONObj = function(stateJSONObj) {
	/*
 ...
 */
IdeaBasketState.prototype.getStudentWork = function() {
...
if(typeof eventManager != 'undefined'){
	...
	eventManager.fire('scriptLoaded', 'vle/node/ideabasket/ideaBasketState.js');
}