(function (window)
{
	...
	p.initialize = function (pan_width_px, pan_height_px, pan_dy_px, base_width_px, base_height_px, base_height_edge_px, stem_width_px, stem_height_px, beam_length_x_px, beam_length_y_px, beam_height_px, beam_height_edge_px, savedObject){
		...
		g.moveTo(-this.base_width_px/2-base_width_from_depth/2, this.stem_height_px + base_height_from_depth/2);
		g.lineTo(-this.base_width_px/2-base_width_from_depth/2, this.stem_height_px - this.base_height_edge_px + base_height_from_depth/2);
		g.lineTo(-this.stem_width_px/2-base_width_from_depth/2, this.stem_height_px - this.base_height_px + base_height_from_depth/2);
		g.lineTo(+this.stem_width_px/2-base_width_from_depth/2, this.stem_height_px - this.base_height_px + base_height_from_depth/2);
		g.lineTo(+this.base_width_px/2-base_width_from_depth/2, this.stem_height_px - this.base_height_edge_px + base_height_from_depth/2);
		g.lineTo(+this.base_width_px/2-base_width_from_depth/2, this.stem_height_px + base_height_from_depth/2);
		g.lineTo(-this.base_width_px/2-base_width_from_depth/2, this.stem_height_px + base_height_from_depth/2);
		g.endFill();
		...
		g.moveTo(-this.base_width_px/2-base_width_from_depth/2, this.stem_height_px - this.base_height_edge_px + base_height_from_depth/2);
		g.lineTo(-this.base_width_px/2+base_width_from_depth/2, this.stem_height_px - this.base_height_edge_px - base_height_from_depth/2);
		g.lineTo(-this.stem_width_px/2+base_width_from_depth/2, this.stem_height_px - this.base_height_px - base_height_from_depth/2);
		g.lineTo(+this.stem_width_px/2+base_width_from_depth/2, this.stem_height_px - this.base_height_px - base_height_from_depth/2);
		g.lineTo(this.base_width_px/2+base_width_from_depth/2, this.stem_height_px - this.base_height_edge_px - base_height_from_depth/2);
		...
		g.moveTo(-this.stem_width_px/2, this.stem_height_px - this.base_height_px);
		g.lineTo(-this.stem_width_px/2, this.base_height_px);
		g.lineTo(0, 0);
		g.lineTo(+this.stem_width_px/2, this.base_height_px);
		g.lineTo(+this.stem_width_px/2, this.stem_height_px - this.base_height_px);
		g.lineTo(-this.stem_width_px/2, this.stem_height_px - this.base_height_px);
		g.endFill();
